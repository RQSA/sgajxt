...
//         echo $tp;
		...
		<?php
		    ...
		    ?>
		    <div style="align-content: center;"><p style="font-size: 15pt; text-align: center;font-weight: bold;">安全隐患图片</p></div>
		    <?php	
		    }
