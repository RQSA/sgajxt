...
//										echo $_GET["id"];
                    ...
                    <div class="form-group">
										...
										<!--<div class="form-group">-->
											...
											{
											?>
											<button type="button" class="btn btn-primary my_none col-sm-offset-9" id="<?php echo $row["id"];?>" name="1" onclick="tijiao(this.id,this.name)">提交</button>
...
//										  echo "$gcdsjc";
                     ...
                     <div class="form-group">
                     	...
                     	<div class="col-sm-2">
                     		<input type="text" class="form-control hidden" id="gcdsjc" name="gcdsjc"  value="<?php echo $row["id"];?>">
                     		<input type="text" class="form-control" id="" name="bMen" placeholder="部门" value="<?php echo $row["部门"];?>">
                     	...
                     	<div class="col-sm-2">
                     		<input type="text" class="form-control" id="" name="gWei" placeholder="岗位" value="<?php echo $row["岗位"];?>">
                     	</div>
                     	<div class="col-sm-2">
                     		<input type="text" class="form-control" id="" name="gLry" placeholder="管理人员" value="<?php echo $row["姓名"];?>">
                     	</div>
                     	<div class="col-sm-2">
                     		<input type="text" class="form-control" id="" name="lXi" placeholder="联系方式" value="<?php echo $row["联系方式"];?>">
                     	</div>
...
//			var x = dtcja.length; //initlal text box count
			...
			return false;  
			  ...
			  save3.addEventListener('click',function(){
			  	...
			  	var inputModify=modify.getElementsByTagName("input");
			  	//获取内容进行修改
			  	var xg="";
			  	for(var k=0;k<inputModify.length;k++){
			  		var obj = inputModify[k].value;
			  		xg += obj + "//";
			  	}
//			  	alert(xg);
